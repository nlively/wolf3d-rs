...
fn make_test_level() -> Level {
    ...
    // Fill plane 0 (walls) with a simple 16x16 room in the top-left corner of
    // the 64x64 grid.  Border tiles = 1 (solid wall), interior = 0 (floor).
    let room = 16usize;
    for y in 0..room {
        for x in 0..room {
...
fn main() {
    ...
    // Save to output/render_test.png
